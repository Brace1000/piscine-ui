...
1. Clone the repository:  
   ```bash  
   git clone https://learn.zone01kisumu.ke/git/bobaigwa/building-an-interface.git  
   ```  
...
[Piscine-UI](https://github.com/Brace1000/UI.git)


1. Clone the repository:
   ```bash
   git clone https://github.com/Brace1000/UI.git
   ```
...
## About
**Author**: Brian Oiko
**GitHub**: [Brian Oiko](https://github.com/Brace1000)  
